...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Aprenda a organizar seu dinheiro, poupar mais, criar renda extra e melhorar sua vida financeira com conteúdos simples e práticos." },
      ...
      { property: "og:title", content: "Meu Bolso em Dia — Educação Financeira e Dicas para Poupar" },
